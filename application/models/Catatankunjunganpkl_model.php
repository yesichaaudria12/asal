...
class catatankunjunganpkl_model extends CI_Model
{
    ...
    public function getAll()
    {
        ...
        $this->db->where('pengajuanpkl.id_peserta', $this->session->userdata('id_peserta'));
    ...
    public function getGuruPembimbing()
    {
        ...
        return $this->db->get_where($this->_table1, ["pengajuanpkl.id_peserta" => $this->session->userdata('id')])->row();
    }
}
