...
class penilaianprakerin_model extends CI_Model
{

    private $_table = 'data_peserta';
    private $_table_nilai = 'penilaian_prakerin';

    public function getAll()
    {
        $this->db->select('data_peserta.id_peserta, data_peserta.kelas, data_peserta.nama_peserta, jurusan.nama_jurusan, data_mentor.nama_mentor, penilaian_prakerin.id_penilaian_prakerin');
        $this->db->from('data_peserta');
        $this->db->join('pengajuanprakerin', 'pengajuanprakerin.id_peserta = data_peserta.id_peserta', 'left');
        $this->db->join('data_mentor', 'data_mentor.id_mentor = pengajuanprakerin.id_mentor', 'left');
        $this->db->join('penilaian_prakerin', 'penilaian_prakerin.id_peserta = data_peserta.id_peserta', 'left');
        $this->db->join('jurusan', 'jurusan.id_jurusan = data_peserta.id_jurusan');
        $this->db->where('pengajuanprakerin.status_validasi', 'Diterima');
        $query = $this->db->get();
        return $query->result();
    }
    ...
    {
        $this->db->join('jurusan', 'jurusan.id_jurusan = data_peserta.id_jurusan');
        $this->db->join('pengajuanprakerin', 'pengajuanprakerin.id_peserta = data_peserta.id_peserta');
