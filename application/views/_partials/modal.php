                  ...
                  <div class="modal-body">
                      ...
                      <form action="<?= base_url('admin/Akun/tambahakun') ?>" method="post">
                          ...
                          <div class="form-group">
                              ...
                              <select class="form-control <?php echo form_error('id_peserta') ? 'is-invalid' : '' ?>" required="required" name="id">
                      ...
                      <?php if ($pengajuanprakerin->status_keanggotaan == "Ketua Kelompok") { ?>
                          <form action="<?= base_url('peserta/PresensiPRAKERIN/tambahpresensiprakerin') ?>" method="post">
                              ...
                              <div class="form-group">
                                  ...
                                  <select class="form-control <?php echo form_error('id_peserta') ? 'is-invalid' : '' ?>" required="required" name="id_peserta">
      ...
      <div class="modal fade" id="tambahpermohonanprakerin" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                      ...
                      <?php if (empty($permohonanprakerin->status_validasi) || $permohonanprakerin->status_validasi == "Ditolak") { ?>
                          ...
                          <form action="<?= base_url('peserta/PermohonanPRAKERIN/tambahpermohonanprakerin') ?>" method="post">
                              ...
                              <div class="form-group">
                                  ...
                                  <select class="form-control <?php echo form_error('id_mentor') ? 'is-invalid' : '' ?>" required="required" name="id_mentor">
                                      <?php foreach ($data_mentor as $row) { ?>
                                          <?php if ($row->kuota > 0) { ?>
                                  ...
                                  <input type="hidden" name="id_peserta" value="<?php echo $this->session->userdata('id') ?>" />
