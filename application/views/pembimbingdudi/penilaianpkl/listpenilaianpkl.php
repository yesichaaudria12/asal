                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="170" style="text-align:center">
                                                ...
                                                <a href="<?= base_url('pembimbingdudi/PenilaianPKL/tambahpenilaianpkl/' . $dtsiswa->id_siswa) ?>"
                                                    class="btn btn-small"><i class="fas fa-fw fa-plus-square"></i>
                                                    Tambah</a>
                                                <?php } else { ?>
                                                <a href="<?= base_url('pembimbingdudi/PenilaianPKL/editpenilaianpkl/' . $dtsiswa->id_siswa) ?>"
                                                    class="btn btn-small"><i class="fas fa-edit"></i> Ubah</a>
                                                <a href="<?= base_url('pembimbingdudi/PenilaianPKL/lihatpenilaianpkl/' . $dtsiswa->id_siswa) ?>"
                                                    class="btn btn-small"><i class="fas fa-clipboard"></i> Lihat</a>
                                                <?php } ?>
                                            </td>
                                            <?php $i++ ?>
                                        </tr>
