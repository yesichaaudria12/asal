            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-2">
                        <h1 class="h2 mr-4 mb-0 text-gray-800">Edit Data Penilaian Prakerin</h1>
                    </div>

                    <div class="card mb-3">
                        <div class="card-header">
                            <a href="<?= base_url('admin/PenilaianPRAKERIN/') ?>"><i class="fas fa-arrow-left"></i>
                                Back</a>
                        </div>
                        <div class="card-body">

                            <form action="<?= base_url('admin/PenilaianPRAKERIN/editnilaiprakerin') ?>" method="post">
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <input class="form-control" readonly value="<?php echo $data_peserta->nama_mentor ?>" />
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <div class="form-group w-75">
                                        <label class="mt-4" for="aspek_teknis_1"><strong>B. Aspek Non
                                                Teknis</strong></label>
