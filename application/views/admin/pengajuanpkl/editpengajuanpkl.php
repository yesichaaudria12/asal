                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <a href="<?= base_url('admin/PengajuanPKL/') ?>"><i class="fas fa-arrow-left"></i>
                                Back</a>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="" method="post">
                                ...
                                <input type="hidden" name="id_pengajuanpkl"
                                    value="<?php echo $pengajuanpkl->id_pengajuanpkl ?>" />

                                <div class="form-group">
                                    <label for="nama_peserta">Nama Peserta</label>
                                    <input
                                        class="form-control <?php echo form_error('nama_peserta') ? 'is-invalid' : '' ?>"
                                        name="nama_peserta" readonly value="<?php echo $pengajuanpkl->nama_peserta ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control <?php echo form_error('kelas') ? 'is-invalid' : '' ?>"
                                        name="kelas" readonly value="<?php echo $pengajuanpkl->kelas ?>" />
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group row row-cols-1 row-cols-sm-2">
                                    ...
                                    <div class="col">
                                        ...
                                        <input
                                            ...
                                            value="<?php echo $pengajuanpkl->tanggal_masuk ?>" />
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col">
                                        ...
                                        <input
                                            ...
                                            value="<?php echo $pengajuanpkl->tanggal_keluar ?>" />
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control <?php echo form_error('id_guru') ? 'is-invalid' : '' ?>"
                                        name="id_guru">
                                        <option value="<?php echo $pengajuanpkl->id_guru; ?>">Pilih Guru :
                                            <?php echo $pengajuanpkl->nama_guru; ?> </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        <option value="<?php echo $pengajuanpkl->status_validasi; ?>">---Status
                                            Validasi-- : <?php echo $pengajuanpkl->status_validasi; ?></option>
