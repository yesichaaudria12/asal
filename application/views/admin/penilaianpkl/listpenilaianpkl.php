                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="170" style="text-align:center">
                                                ...
                                                <a href="<?= base_url('admin/PenilaianPKL/tambahpenilaianpkl/' . $dtsiswa->id_siswa) ?>"
                                                    class="btn btn-small"><i class="fas fa-fw fa-plus-square"></i>
                                                    Tambah</a>
                                                <?php } else { ?>
                                                <a href="<?= base_url('admin/PenilaianPKL/editpenilaianpkl/' . $dtsiswa->id_siswa) ?>"
                                                    class="btn btn-small"><i class="fas fa-edit"></i> Ubah</a>
                                                <a href="<?= base_url('admin/PenilaianPKL/lihatpenilaianpkl/' . $dtsiswa->id_siswa) ?>"
