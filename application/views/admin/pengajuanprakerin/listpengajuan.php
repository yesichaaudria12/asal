                                    ...
                                    <tbody>
                                        ...
                                        foreach ($pengajuanprakerin as $pengajuan) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $pengajuan->nama_peserta; ?>
                                                </td>
                                                <td style="text-align:center">
                                                ...
                                                <td style="text-align:center">
                                                    <a href="<?= base_url('admin/PengajuanPRAKERIN/editpengajuanprakerin/' . $pengajuan->id_pengajuanprakerin) ?>" class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
                                                </td>
                                                <?php $i++ ?>
                                            </tr>
                                        <?php endforeach; ?>
