                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <a href="<?= base_url('admin/DataPeserta/') ?>"><i class="fas fa-arrow-left"></i> Kembali</a>
                        </div>
                        <div class="card-body">

                            <form action="" method="post">

                                <input type="hidden" name="id_peserta" value="<?php echo $datapeserta->id_peserta ?>" />

                                <div class="form-group">
                                    <label for="nis_nim">NIS / NIM *</label>
                                    <input class="form-control <?php echo form_error('nis_nim') ? 'is-invalid' : '' ?>"
                                        type="text" name="nis_nim" placeholder="NIS / NIM*"
                                        value="<?php echo $datapeserta->nis_nim ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="<?php echo $datapeserta->nama_peserta ?>" />
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="<?php echo $datapeserta->kelas ?>" />
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        <option value="1" <?php echo set_select('id_jurusan', '1', ($datapeserta->id_jurusan == '1')) ?>>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <option value="1" <?php echo set_select('jenis_kelamin', '1', ($datapeserta->jenis_kelamin == '1')) ?>>
                                             Laki-Laki
                                        </option>
                                        <option value="2" <?php echo set_select('jenis_kelamin', '2', ($datapeserta->jenis_kelamin == '2')) ?>>
                                             Perempuan
                                        </option>
                                        </select>
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control <?php echo form_error('hp_peserta') ? 'is-invalid' : '' ?>"
                                        type="number" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" name="hp_peserta" placeholder=""
                                        value="<?php echo set_value('hp_peserta', $datapeserta->hp_peserta) ?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control <?php echo form_error('ayah') ? 'is-invalid' : '' ?>"
                                        type="text" name="ayah" placeholder=""
                                        value="<?php echo set_value('ayah', $datapeserta->ayah) ?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="<?php echo set_value('no_hp_orang_tua', $datapeserta->no_hp_orang_tua) ?>">
                                    <div class="invalid-feedback">
