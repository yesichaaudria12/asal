                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="185" style="text-align:center">
                                                <a href="<?= base_url('siswa/ProgramPKL/editprogrampkl/' . $program->id_program_pkl) ?>"
                                                    class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
                                                <a onclick="deleteConfirm('<?= base_url('siswa/ProgramPKL/hapusprogrampkl/' . $program->id_program_pkl) ?>')"
