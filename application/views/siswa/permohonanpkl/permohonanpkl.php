                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-header d-flex justify-content-between mb-2">
                            <button type="button" class="btn btn-light" data-toggle="modal"
                                data-target="#tambahpermohonanpkl"><i class="fas fa-plus"></i> Tambah Permohonan
                                PKL</button>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-light" role="alert">
                                <h4 class="alert-heading"><strong>Maaf, Anda belum mengajukan permohonan PKL!</strong>
                                </h4>
                                <p>Silahkan mengajukan permohonan PKL sesuai jadwal kegiatan PKL di jurusan Anda.</p>
                                <hr>
                                <p class="mb-0">Jika terdapat pernyataan terkait PKL, silahkan hubungi Koordinator PKL,
                            ...
                            <div class="alert alert-success" role="alert">
                                ...
                                <p>Selamat, permohonan PKL Anda telah diterima oleh pihak perusahaan
                                    <strong><?php echo $permohonanpkl->nama_dudi ?></strong>, berikut adalah keterangan
                                    terkait pelaksanaan PKL : </p>
                                <p><strong>Tanggal Masuk Pelaksanaan PKL :
                                        <?php echo date("d-m-Y", strtotime($permohonanpkl->tanggal_masuk)) ?></strong>
                                </p>
                                <p><strong>Tanggal Usai Pelaksanaan PKL :
                                        <?php echo date("d-m-Y", strtotime($permohonanpkl->tanggal_keluar)) ?></strong>
                                </p>
                                <p><strong>Status Keanggotan Kelompok PKL :
                                        <?php echo $permohonanpkl->status_keanggotaan ?></strong></p>
                            ...
                            <div class="alert alert-warning" role="alert">
                                ...
                                <p>Permohonan PKL Anda sedang diproses oleh Koordinator PKL dan akan diteruskan kepada
                            ...
                            <div class="alert alert-danger" role="alert">
                                ...
                                <p>Maaf, permohonan PKL Anda ditolak oleh pihak perusahaan
                                    <strong><?php echo $permohonanpkl->nama_dudi ?></strong>.</p>
                            ...
                            <div class="alert alert-secondary" role="alert">
                                ...
                                <p>Permohonan PKL Anda akan diproses oleh Koordinator PKL dan akan diteruskan kepada
                                    pihak perusahaan <strong><?php echo $permohonanpkl->nama_dudi ?></strong>.</p>
                                <p>Anda dapat menghapus permohonan PKL saat ini jika terdapat kesalahan memasukkan data
                                    permohonan PKL.</p>
                                <a onclick="deleteConfirm('<?= base_url('siswa/PermohonanPKL/hapuspermohonanpkl/' . $permohonanpkl->id_pengajuanpkl) ?>')"
