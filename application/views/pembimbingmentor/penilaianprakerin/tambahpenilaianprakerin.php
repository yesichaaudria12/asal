            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-2">
                        <h1 class="h2 mr-4 mb-0 text-gray-800">Add Data Penilaian Prakerin</h1>
                    </div>

                    <div class="card mb-3">
                        <div class="card-header">
                            <a href="<?= base_url('pembimbingmentor/PenilaianPRAKERIN/') ?>"><i class="fas fa-arrow-left"></i>
                                Kembali</a>
                        </div>
                        <div class="card-body">

                            <form action="<?= base_url('pembimbingmentor/PenilaianPRAKERIN/tambahnilaiprakerin') ?>" method="post">
                                <div class="row">
