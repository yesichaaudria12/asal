                                    ...
                                    <tbody>
                                        ...
                                        foreach ($jurnal_prakerin as $jurnal) : ?>
                                            <tr>
                                                ...
                                                <td style="text-align:center">
                                                    <a href="<?= base_url('pembimbingmentor/ValidasiJurnalPRAKERIN/editvalidasijurnalprakerin/' . $jurnal->id_jurnal_prakerin) ?>" class="btn btn-primary text-white"><i class="fas fa-clipboard-check"></i> Validasi</a>
                                                </td>
                                                <?php $i++ ?>
                                            </tr>
                                        <?php endforeach; ?>
