                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-header">
                            <a href="<?= base_url('peserta/ProgramPRAKERIN/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
                        </div>
                        <div class="card-body">
                            <form action="" method="post">

                                <input type="hidden" name="id_program_prakerin"
                                    value="<?php echo $programprakerin->id_program_prakerin ?>" />
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-3">
                                        ...
                                        <input
                                            ...
                                            value="<?php echo $programprakerin->tanggal ?>"></input>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea
                                        ...
                                        placeholder=""><?php echo $programprakerin->topik_pekerjaan ?></textarea>
                                    <div class="invalid-feedback">
