...
$pdf->SetTitle('Laporan Program Prakerin - '  . $data_program_prakerin->nama_peserta);
...
$html = '
  ...
  <tr>
    ...
    <td> : ' . $data_program_prakerin->nama_peserta . '</td>
  </tr>
  <tr>
    <td width="30%">Kelas</td>
    <td> : ' . $data_program_prakerin->kelas . '</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td> : ' . $data_program_prakerin->nama_jurusan . '</td>
  </tr>
  <tr>
    <td width="30%">Nama Mentor</td>
    <td> : ' . $data_program_prakerin->nama_mentor . '</td>
  </tr>
  <tr>
    <td width="30%">Alamat</td>
    <td> : ' . $data_program_prakerin->alamat_mentor . '</td>
  </tr>
  <tr>
    <td width="30%">Waktu Prakerin</td>
    <td> : ' . date("d-m-Y", strtotime($data_program_prakerin->tanggal_masuk)) . ' - ' . date("d-m-Y", strtotime($data_program_prakerin->tanggal_keluar)) . '</td>
  </tr>
    <tr>
    <td></td>
  </tr>
...
foreach ($program_prakerin as $row) {
...
$pdf->Output('Laporan Program Prakerin ' . $data_program_prakerin->nama_peserta . '.pdf', 'I');