                        ...
                        <div class="card-body">
                            <div class="alert alert-danger" role="alert">
                                ...
                                <p class="mb-0">Jika terdapat pernyataan terkait Prakerin, silahkan hubungi Koordinator
                                    Prakerin, Bapak/Ibu Guru, atau Koordinator Jurusan di Program Studi Anda</p>
                            </div>
                        </div>
                        <?php } else { ?>
                        <div class="card-header d-flex justify-content-between">
                            <a class="btn btn-light" href="<?= base_url("peserta/ProgramPRAKERIN/tambahprogramprakerin") ?>"><i
                                    class="fas fa-plus"></i> Add New Data Program Prakerin</a>
                            <a class="btn btn-light"
                                href="<?= base_url("peserta/ProgramPRAKERIN/cetak_program_prakerin/" . $this->session->userdata('id_peserta')) ?>"><i
                            ...
                            <div class="table-responsive">
                                <table id="table_id" class="table table-striped table-bordered" cellspacing="0"
                                    ...
                                    <tbody>
                                        <?php
                                            $i = 1;
                                            foreach ($program_prakerin as $program) : ?>
                                        <tr>
                                            ...
                                            <td width="185" style="text-align:center">
                                                <a href="<?= base_url('peserta/ProgramPRAKERIN/editprogramprakerin/' . $program->id_program_prakerin) ?>"
                                                    class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
                                                <a onclick="deleteConfirm('<?= base_url('peserta/ProgramPRAKERIN/hapusprogramprakerin/' . $program->id_program_prakerin) ?>')"
