                        ...
                        <?php } else { ?>
                            ...
                            <div class="card-body">
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="id_jurnal_prakerin" value="<?php echo $jurnalprakerin->id_jurnal_prakerin ?>" />
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-3">
                                            ...
                                            <input class="form-control <?php echo form_error('tanggal') ? 'is-invalid' : '' ?>" id="datepicker" type="date" name="tanggal" placeholder="" value="<?php echo $jurnalprakerin->tanggal ?>"></input>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control <?php echo form_error('topik_pekerjaan') ? 'is-invalid' : '' ?>" type="text" name="topik_pekerjaan" placeholder=""><?php echo $jurnalprakerin->topik_pekerjaan ?></textarea>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group d-flex justify-content-center">
                                        <img class="col-lg-6" src="<?php echo base_url('dokumentasi/' . $jurnalprakerin->dokumentasi) ?>" width="480" height="320" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="old_image" value="<?php echo $jurnalprakerin->dokumentasi ?>" />
                                        <div class="invalid-feedback">
