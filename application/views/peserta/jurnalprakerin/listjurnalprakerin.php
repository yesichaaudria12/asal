            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php if (!isset($pengajuanprakerin->status_validasi) || $pengajuanprakerin->status_validasi != "Diterima") { ?>
                            ...
                            <div class="card-body">
                                <div class="alert alert-danger" role="alert">
                                    ...
                                    <p>Karena pengajuan Prakerin Anda masih berstatus
                                        ...
                                        <?php } else { ?>
                                            <strong><?php echo $pengajuanprakerin->status_validasi ?></strong>.
                                    </p>
                                <?php } ?>
                                <hr>
                        ...
                        <?php } else { ?>
                            <?php foreach ($jurnal_prakerin as $jurnal) :
                                ...
                                <?php } else { ?>
                                    <div class="alert alert-danger" role="alert">
                                        Anda belum mengisi jurnal kegiatan PRAKERIN hari ini!
                                    </div>
                                <?php } ?>
                                <?php break; ?>
                            <?php endforeach; ?>
                            <div class="card mb-3">
                                <div class="card-header d-flex bd-highlight">
                                    <div class="mr-auto p-2 bd-highlight">
                                        <a class="btn btn-light" href="<?= base_url("peserta/JurnalPRAKERIN/tambahjurnalprakerin") ?>"><i class="fas fa-plus"></i> Add New Data Logbook</a>
                                    </div>
                                    <div class="p-2 bd-highlight">
                                        <a class="btn btn-light" href="<?= base_url("peserta/JurnalPRAKERIN/cetak_jurnal_prakerin/" . $this->session->userdata('id_peserta')) ?>"><i class="fas fa-print"></i> Print Data Logbook </a>
                                    </div>
                                    <div class="p-2 bd-highlight">
                                        <a class="btn btn-light" href="<?= base_url("peserta/JurnalPRAKERIN/cetak_dokumentasi_jurnal/" . $this->session->userdata('id_peserta')) ?>"><i class="fas fa-print"></i> Print Lampiran Dokumentasi</a>
                                    </div>
                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($jurnal_prakerin as $jurnal) : ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align:center">
                                                            <a href="<?= base_url('peserta/JurnalPRAKERIN/editjurnalprakerin/' . $jurnal->id_jurnal_prakerin) ?>" class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
                                                            <a onclick="deleteConfirm('<?= base_url('peserta/JurnalPRAKERIN/hapusjurnalprakerin/' . $jurnal->id_jurnal_prakerin) ?>')" href="#!" class="btn btn-small text-danger"><i class="fas fa-trash"></i>Delete</a>
                                                        </td>
                                                        <?php $i++ ?>
                                                    </tr>
