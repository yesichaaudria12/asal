...
$pdf->SetTitle('Lampiran Dokumentasi Logbook - '  . $data_jurnal_prakerin->nama_peserta);
...
$i = 0;
$html = '
<h2 style="text-align:center;">LAMPIRAN LOGBOOK PRAKERIN</h2>
...
$pdf->Output('Laporan Jurnal PRAKERIN - '  . $data_jurnal_prakerin->nama_peserta . '.pdf', 'I');
