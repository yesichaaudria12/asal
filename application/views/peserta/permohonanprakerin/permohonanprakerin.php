            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                        ...
                        <?php if (empty($permohonanprakerin->status_validasi)) { ?>
                        <div class="card-header d-flex justify-content-between mb-2">
                            <button type="button" class="btn btn-light" data-toggle="modal"
                                data-target="#tambahpermohonanprakerin"><i class="fas fa-plus"></i> Add Permohonan
                                Prakerin</button>
                        </div>
                        <?php } elseif ($permohonanprakerin->status_validasi == 'Ditolak') { ?>
                        <div class="card-header d-flex justify-content-between mb-2">
                            <button type="button" class="btn btn-light" data-toggle="modal"
                                data-target="#tambahpermohonanprakerin"><i class="fas fa-plus"></i> Add Permohonan
                                Prakerin</button>
                        ...
                        <div class="card-body">
                            ...
                            <?php } elseif ($permohonanprakerin->status_validasi == 'Diterima') { ?>
                                ...
                                <div class="alert alert-success" role="alert">
                                    ...
                                    <p>Selamat, permohonan Prakerin Anda telah diterima oleh pihak perusahaan
                                        <strong><?php echo $permohonanprakerin->nama_mentor ?></strong>, berikut adalah keterangan
                                        terkait pelaksanaan Prakerin :
                                    </p>
                                    <p><strong>Tanggal Masuk Pelaksanaan Prakerin :
                                            <?php echo date("d-m-Y", strtotime($permohonanprakerin->tanggal_masuk)) ?></strong>
                                    </p>
                                    <p><strong>Tanggal Usai Pelaksanaan Prakerin :
                                            <?php echo date("d-m-Y", strtotime($permohonanprakerin->tanggal_keluar)) ?></strong>
                                    </p>
                                    <p><strong>Status Keanggotan Kelompok Prakerin :
                                            <?php echo $permohonanprakerin->status_keanggotaan ?></strong></p>
                                    <?php if ($permohonanprakerin->id_guru == 0) { ?>
                                        <p><strong>Nama Guru Pembimbing : Belum Ditentukan</strong></p>
                                        <hr>
                                    <?php } else { ?>
                                        <p><strong>Nama Guru Pembimbing : <?php echo $permohonanprakerin->nama_guru ?></strong></p>
                                    <?php } ?>
                                    <p>Silahkan mempersiapkan diri untuk memulai pelaksanaan Prakerin, semoga sukses!</p>
                                    <p class="mb-0">Jika terdapat pernyataan terkait Prakerin, silahkan hubungi Koordinator Prakerin,
                                        Bapak/Ibu Guru, atau Koordinator Jurusan di Program Studi Anda</p>
                                </div>

                            <?php } elseif ($permohonanprakerin->status_validasi == 'Proses Pengajuan') { ?>
                                ...
                                <div class="alert alert-warning" role="alert">
                                    ...
                                    <p>Permohonan Prakerin Anda sedang diproses oleh Koordinator Prakerin dan akan diteruskan kepada
                                        pihak perusahaan <strong><?php echo $permohonanprakerin->nama_mentor ?></strong>.</p>
                            ...
                            <?php } elseif ($permohonanprakerin->status_validasi == 'Ditolak') {  ?>
                                ...
                                <div class="alert alert-danger" role="alert">
                                    ...
                                    <p>Maaf, permohonan Prakerin Anda ditolak oleh pihak perusahaan
                                        <strong><?php echo $permohonanprakerin->nama_mentor ?></strong>.
                                    </p>
                            ...
                            <?php } elseif ($permohonanprakerin->status_validasi == 'Belum Tervalidasi') { ?>
                                ...
                                <div class="alert alert-secondary" role="alert">
                                    ...
                                    <a onclick="deleteConfirm('<?= base_url('peserta/PermohonanPRAKERIN/hapuspermohonanprakerin/' . $permohonanprakerin->id_pengajuanprakerin) ?>')" href="#!" class="btn btn-danger"><i class="fas fa-trash"></i> Delete</a>
                                    <hr>
                                    <p class="mb-0">Jika terdapat pernyataan terkait Prakerin, silahkan hubungi Koordinator Prakerin,
                                        Bapak/Ibu Guru, atau Koordinator Jurusan di Program Studi Anda</p>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table id="table" class="table table-striped table-bordered" cellspacing="0"
                                    ...
                                    <tbody>
                                        <?php
                                        $i = 1;
                                        foreach ($pengajuanprakerin as $pengajuan) : ?>
                                            <tr>
