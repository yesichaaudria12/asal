...
<body id="page-top">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="alert alert-danger" role="alert">
                                <h4 class="alert-heading"><strong>Maaf, Anda tidak diizinkan mengakses menu
                                        ini!</strong></h4>
                        ...
                        <div class="card-header">
                            <a href="<?= base_url('peserta/ProgramPKL/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
                        </div>
                        <div class="card-body">
                            <form action="" method="post">

                                <input type="hidden" name="id_program_pkl"
                                    value="<?php echo $programpkl->id_program_pkl ?>" />

                                <input type="hidden" name="id_peserta"
                                    value="<?php echo $this->session->userdata('id_peserta') ?>" />
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-3">
                                        ...
                                        <input
                                            ...
                                            id="datepicker" type="date" name="tanggal" placeholder=""
                                            value="<?php echo $programpkl->tanggal ?>"></input>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control <?php echo form_error('mapel') ? 'is-invalid' : '' ?>"
                                        name="mapel" id="mapel">
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        class="id_kompetensi_dasar form-control <?php echo form_error('id_kompetensi_dasar') ? 'is-invalid' : '' ?>"
                                        name="id_kompetensi_dasar" id="id_kompetensi_dasar">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea
                                        ...
                                        placeholder=""><?php echo $programpkl->topik_pekerjaan ?></textarea>
                                    <div class="invalid-feedback">
    ...
    $(document).ready(function() {
        $('#mapel').change(function() {
            var id = $(this).val();
            $.ajax({
                url: "<?php echo base_url(); ?>peserta/JurnalPKL/getKompetensidasar",
                method: "POST",
                data: {
                    id: id
                },
