                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-header d-flex justify-content-between">
                            <a class="btn btn-light" href="<?= base_url("peserta/ProgramPKL/tambahprogrampkl") ?>"><i
                                    class="fas fa-plus"></i> Add New Data Program Prakerin</a>
                            <a class="btn btn-light"
                                href="<?= base_url("peserta/ProgramPKL/cetak_program_pkl/" . $this->session->userdata('id_peserta')) ?>"><i
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="185" style="text-align:center">
                                                <a href="<?= base_url('peserta/ProgramPKL/editprogrampkl/' . $program->id_program_pkl) ?>"
                                                    class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
                                                <a onclick="deleteConfirm('<?= base_url('peserta/ProgramPKL/hapusprogrampkl/' . $program->id_program_pkl) ?>')"
