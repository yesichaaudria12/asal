                    ...
                    <div class="card mb-3">
                        ...
                        <?php } else { ?>
                            <div class="card-header">
                                <a href="<?= base_url('peserta/JurnalPKL/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
                            </div>
                            <div class="card-body">
                                <form action="<?= base_url('peserta/JurnalPKL/tambahjurnalpkl') ?>" method="post" enctype="multipart/form-data">
