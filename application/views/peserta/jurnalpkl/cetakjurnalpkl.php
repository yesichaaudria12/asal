...
$pdf->SetTitle('Laporan Logbook Prakerin - ' . $data_jurnal_pkl->nama_peserta);
...
<h2 style="text-align:center;">LOGBOOK KEGIATAN PRAKTIK KERJA INDUSTRI (PRAKERIN)</h2>
    ...
    <td> : ' . $data_jurnal_pkl->nama_peserta . '</td>
  </tr>
  <tr>
...
$pdf->Output('Laporan Logbook Prakerin '  . $data_jurnal_pkl->nama_peserta . '.pdf', 'I');