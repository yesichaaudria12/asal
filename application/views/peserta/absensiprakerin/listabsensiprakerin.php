                                            ...
                                            <tbody>
                                                ...
                                                foreach ($absensi as $absen) : ?>
                                                    <tr>
                                                        ...
                                                        <?php if ($pengajuanprakerin->status_keanggotaan == 'Ketua Kelompok') { ?>
                                                            <td style="text-align:center">
                                                                <a onclick="deleteConfirm('<?= base_url('peserta/PresensiPRAKERIN/hapuspresensiprakerin/' . $absen->id_absensi) ?>')" href="#!" class="btn btn-small text-danger"><i class="fas fa-trash"></i> Delete</a>
                                                            </td>
                                                        <?php } ?>
                                                        <?php $i++ ?>
                                                    <?php endforeach; ?>
