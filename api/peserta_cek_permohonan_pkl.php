...
$query = mysqli_query($con, "SELECT * FROM pengajuanpkl where id_peserta=$id_peserta and status_validasi='Diterima' or status_validasi = 'Proses Pengajuan' or status_validasi = 'Belum Tervalidasi'");
