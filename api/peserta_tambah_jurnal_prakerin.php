...
$Sql_Query = "INSERT INTO jurnal_prakerin (id_peserta, id_kompetensi_dasar, tanggal, topik_pekerjaan, dokumentasi) values ('$id_peserta','$id_kompetensi_dasar','$tanggal','$topik_pekerjaan', '$nama_gambar')";
