...
$Sql_Query = "UPDATE program_pkl set id_peserta = '$id_peserta', id_kompetensi_dasar = '$id_kompetensi_dasar', tanggal = '$tanggal', topik_pekerjaan = '$topik_pekerjaan' where program_pkl.id_program_pkl='$id_program_pkl'";
