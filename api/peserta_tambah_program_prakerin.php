...
$Sql_Query = "INSERT INTO program_prakerin (id_peserta, id_kompetensi_dasar, tanggal, topik_pekerjaan) values ('$id_peserta','$id_kompetensi_dasar','$tanggal','$topik_pekerjaan')";
