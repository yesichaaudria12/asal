...
$id_jurnal_prakerin = $_POST['id_jurnal_prakerin'];
...
$Sql_Query = "UPDATE jurnal_prakerin set id_peserta = '$id_peserta', id_kompetensi_dasar = '$id_kompetensi_dasar', tanggal = '$tanggal', topik_pekerjaan = '$topik_pekerjaan', dokumentasi = '$nama_gambar' where jurnal_prakerin.id_jurnal_prakerin='$id_jurnal_prakerin'";
