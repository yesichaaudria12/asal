...
$query = mysqli_query($con, "SELECT * FROM `data_peserta` left join pengajuanprakerin on pengajuanprakerin.id_peserta=data_peserta.id_peserta where data_peserta.id_peserta = $id_peserta and status_validasi='Diterima'");
